...
for(const scene of ['cover','checkpoint','thumbnail']){
 ...
 const css=readFileSync('js13k/src/page.css','utf8')+`\n.press-title{position:absolute;left:7%;top:7%;color:#362344;pointer-events:none}.press-title small{font:700 12px system-ui;letter-spacing:.2em}.press-title h1{font:italic 120px Georgia;margin:6px 0 0;letter-spacing:-6px}.press-title p{font:italic 24px Georgia;color:#c53774;margin:0}[data-scene=thumbnail] .press-title{left:8%;top:5%}[data-scene=thumbnail] h1{font-size:68px;letter-spacing:-3px}[data-scene=thumbnail] small{font-size:8px}[data-scene=thumbnail] p{font-size:14px}[data-scene=checkpoint] .press-title p{font-size:24px}@media(max-width:900px){.press-title h1{font-size:72px;letter-spacing:-3px}.press-title p{font-size:18px}.press-title small{font-size:9px}}@media(max-width:350px){[data-scene=thumbnail] h1{font-size:56px}[data-scene=thumbnail] p{font-size:12px}}`;
